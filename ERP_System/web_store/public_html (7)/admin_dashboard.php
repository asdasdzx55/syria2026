...
<div class="container mx-auto px-4 md:px-8 py-10 max-w-6xl animate-fade-in">
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="/pos/" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-3 rounded-2xl font-black text-sm flex items-center gap-2 shadow-lg shadow-emerald-900/20 transition active:scale-95 border border-emerald-500 animate-pulse">
    ...
    <div class="bg-gradient-to-r from-emerald-900 via-slate-900 to-slate-950 rounded-3xl p-6 mb-8 text-white shadow-xl border border-emerald-500/30 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3 flex-shrink-0">
            <a href="/pos/" target="_blank" class="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black px-6 py-3.5 rounded-2xl text-sm transition shadow-lg flex items-center justify-center gap-2">
